...
配置文件会在 config/iaie-common.toml 中生成。将 disableSolidFuel 设为 false 即可让飞机重新接受煤炭、原木等固体燃料，同时你也可以用液体燃料。
...
Config file will be generated in config/iaie-common.toml. Change "disableSolidFuel" into "false" can allow planes to use solid fuels. Meanwhile you can still use liquid fuels.
